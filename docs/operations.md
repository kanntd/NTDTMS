...
3. Cloudflare R2
   ...
   - สร้าง private bucket สำหรับรูปสินค้าและเอกสาร เช่น `ntdtms-images`
...
- ข้อมูลหลักผู้รับ/ผู้ส่ง สินค้า พนักงาน รถ และเอกสารหลายไฟล์
- รหัสพนักงาน/รถสร้างอัตโนมัติ เอกสารเพิ่มหรือลบได้ทีละรายการ และรถผูกกับพนักงานขับรถปัจจุบัน
- พื้นที่ให้บริการเพิ่ม/หยุดใช้ได้ อำเภอไม่บังคับและเพิ่มหรือลบภายหลังได้
- สิทธิ์เข้าใช้งานแยกจากข้อมูลพนักงาน และกำหนดเป็นรายโมดูล
- ราคาตามคู่ลูกค้า คำขอราคา ประวัติเวอร์ชัน และปรับราคาหลายรายการ
